...
<%
        ...
        if (conn != null) {
			...
			while(rs.next()){
				...
				Mo_No = rs.getInt("m_numbers");
				gender= rs.getString("gender");
				AtmNumber= rs.getInt("ATM_Number");
    ...
    <section>Account Holder Name: <%= name %></section>
        <section>Mobile No. <%= Mo_No %> </section>
        <section>Gender: <%= gender %></section>
        <section>ATM_Number: <%= AtmNumber %></section>
